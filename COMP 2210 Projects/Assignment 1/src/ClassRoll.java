...
public class ClassRoll {
    ...
    public static void main(String[] args) {
        ...
        Collections.shuffle(roll); // shuffle roll in random order
        ...
        // Collections.sort().
        // *** Replace this line with your solution.
        Collections.sort(roll, orderBySection.reversed()); // sort roll in desc order of section
    ...
    public static class CompareStudentsBySection implements Comparator<Student> {
        ...
        public int compare(Student s1, Student s2) {
            return s1.getSection() - s2.getSection(); // compare student objs in asc order of section
        }
    }
